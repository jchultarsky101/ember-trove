        ...
        <div class="border-t border-stone-200 dark:border-stone-800 pt-6">
            ...
            <Suspense fallback=move || view! {
                ...
                {move || {
                    ...
                    // Slice the list: collapsed → first INITIAL_VISIBLE; expanded → all.
                    ...
                    view! {
                        <div>
                            // When all notes are visible, cap height and allow scrolling.
                            <div class=move || {
                            ...
                            // "Show N more" / "Show less" toggle (only when there are hidden notes)
