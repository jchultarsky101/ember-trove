            ...
            <div class="flex items-center justify-between mb-6">
                ...
                <button
                    class="flex items-center gap-2 px-3 py-2 rounded-lg bg-ember
                        text-white text-sm font-medium hover:bg-ember-strong transition-colors"
                    on:click=move |_| {
                        create_error.set(None);
                ...
                view! {
                    <div class="mb-6 p-5 bg-white dark:bg-stone-900 rounded-xl border border-stone-200 dark:border-stone-700 shadow-sm space-y-4">
                        ...
                        <div class="flex items-center justify-between pt-1">
                            ...
                            <button
                                class="px-4 py-2 rounded-lg bg-ember text-white text-sm font-medium
                                    hover:bg-ember-strong disabled:opacity-40 transition-colors"
                                on:click=on_create
                ...
                view! {
                    <div class="px-4 pb-4 pt-2 bg-stone-50 dark:bg-stone-800/50 border-t border-stone-100 dark:border-stone-800">
                        ...
                        <div class="flex items-center gap-2">
                            <button
                                class="px-3 py-1.5 rounded-lg bg-ember text-white text-xs font-medium
                                    hover:bg-ember-strong disabled:opacity-40 transition-colors"
                                on:click={
